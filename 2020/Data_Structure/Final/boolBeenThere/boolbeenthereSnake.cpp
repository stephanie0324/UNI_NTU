...
queue<tuple<int,int>> Snake::nextPosition(vector<vector<int>> map)
{
    ...
    if(turn_cnt<3){
        ...
        {
            if(!collide(position,tuple<int, int>(head_x-1,head_y),map) && been_up == false)
            {
                been_down = true;
                been_left = false;
                been_right = false;
        ...
        if(std::get<0>(target) > head_x)
        {
            if(!collide(position,tuple<int, int>(head_x+1,head_y),map) && been_down ==false)
            {
                been_down = false;
                been_left = false;
                been_right = false;
        ...
        {
            //cout << "at top" <<endl;
            if(!collide(position,tuple<int, int>(head_x,head_y-1),map) && been_left == false)
            {
                been_down = false;
                been_left = false;
                been_right = true;
        ...
        {
            //cout << "at down" <<endl;
            if(!collide(position,tuple<int, int>(head_x,head_y+1),map) && been_right ==false)
            {
                been_down = false;
                been_left = true;
                been_right = false;
